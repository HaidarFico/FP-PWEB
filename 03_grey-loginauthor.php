							...
							<div class="row align-items-center">
								...
								<div class="col-lg-4 offset-lg-4 wow fadeIn bg-color" data-wow-delay=".5s">
									<div class="box-rounded padding40">
										<h3 class="mb10">Log In Author</h3>
										<p>Login using an existing account or create a new account</p><a href="register_author.php">REGISTER</a>
										<form name="contactForm" id='contact_form' class="form-border" method="post" action='login_authorInput.php'>
