                        ...
                        <div class="de-flex sm-pt10">
                            ...
                            <div class="de-flex-col header-col-mid">
                                ...
                                <div class="menu_side_area">
                                    <a href="03_grey-login.php" class="btn-main btn-wallet"><i
                                        ...
                                        <div class="tab-1">
                                            <div class="row wow fadeIn">
                                                ...
                                                <div id="sidebar" class="col-lg-4">
                                                    ...
                                                    <img src="<?php 
                                                        $userDataPhoto = getData();
                                                        echo ('./uploadedImages/' . $userDataPhoto[6]);?>" 
                                                id="click_profile_img" class="d-profile-img-edit img-fluid" alt="">
                                                    ...
                                                    <img src="images/author_single/author_banner.jpg"
                                                        id="click_banner_img" class="d-banner-img-edit img-fluid"
                                                        alt="">
                                            ...
                                            <div class="row wow fadeIn">
                                                <div class="col-md-6 mb-sm-20">
                                                    ...
                                                    <div class="switch-with-title s2">
                                                        <h5>Price Change</h5>
                                                        <div class="de-switch">
                                                            <input type="checkbox" id="notif-price-change"
                                                                class="checkbox">
                                                ...
                                                <div class="col-md-6">
                                                    ...
                                                    <div class="switch-with-title s2">
                                                        ...
                                                        <div class="clearfix"></div>
                                                        <p class="p-info">When an offer you placed is exceeded by
                                                            another user.</p>
                                                    </div>
